...
struct crypto_algo crypto_algos[] = {
	...
	},
	{
		.name = "ml-dsa-44",
		.key_len = 32,
		.sign = pqc_fit_sign_mldsa44,
		.add_verify_data = pqc_add_verify_data,
		.verify = pqc_fit_verify_mldsa44,
	},
	{
		.name = "sphincs-plus",
		.key_len = 32,
		.sign = pqc_fit_sign_sphincs,
		.add_verify_data = pqc_add_verify_data,
		.verify = pqc_fit_verify_sphincs,
	},
	{
		.name = "lms",
		.key_len = 32,
		.sign = pqc_fit_sign_lms,
		.add_verify_data = pqc_add_verify_data,
		.verify = pqc_fit_verify_lms,
	},
};
