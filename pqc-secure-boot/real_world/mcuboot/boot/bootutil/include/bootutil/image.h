...
#define IMAGE_TLV_SIG_PURE          0x25    /* Indicator that attached signature has been prepared
                                             ...
                                             */
#define IMAGE_TLV_ML_DSA_44         0x80    /* ML-DSA-44 post-quantum signature */
#define IMAGE_TLV_SPHINCS_PLUS      0x81    /* SPHINCS+ post-quantum signature */
#define IMAGE_TLV_LMS               0x82    /* LMS post-quantum signature */
#define IMAGE_TLV_PQC_PUBKEY        0x88    /* PQC Public key */
